...
author: QuantEcon
excerpt: A new lecture on differentiable Kalman filters has been added to the Julia series, featuring high-performance coding patterns for both forward-mode and reverse-mode automatic differentiation with Enzyme.
tag: [lectures]
---
...
This lecture covers implementing and differentiating the Kalman filter using both forward-mode and reverse-mode automatic differentiation. It documents specific coding patterns needed to get high performance while remaining compatible with [Enzyme](https://github.com/EnzymeAD/Enzyme.jl).
